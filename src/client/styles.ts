...
.nb-set-card{--nb-surface:var(--dsw-alias-bg-layer-1,#fff);--nb-muted:var(--dsw-alias-label-secondary,#73777e);--nb-text:var(--dsw-alias-label-primary,#24272c);--nb-border:var(--dsw-alias-border-l1,#dfe1e5);--nb-accent:var(--dsw-alias-state-accent-primary,#4264e8);--nb-hover:var(--dsw-alias-interactive-bg-hover,#f0f1f4);list-style:none;width:100%;min-width:0;border:1px solid var(--nb-border);border-radius:12px;color:var(--nb-text);background:var(--dsw-alias-bg-layer-3,#fff);font:inherit;letter-spacing:0}
.nb-set-card *{box-sizing:border-box;letter-spacing:0}.nb-set-card button,.nb-set-card input,.nb-set-card select,.nb-set-card textarea{font:inherit;color:inherit}.nb-set-card button{cursor:pointer}.nb-set-card :disabled{opacity:.45;cursor:not-allowed}.nb-set-card :focus-visible{outline:2px solid var(--nb-accent);outline-offset:3px}
.nb-set-header{display:flex;align-items:center;justify-content:space-between;gap:16px;width:100%;padding:20px 24px;border:0;border-radius:12px;background:none;text-align:left}.nb-set-header>span{min-width:0;overflow-wrap:anywhere}.nb-set-header strong{display:block;font-size:14px;font-weight:600;line-height:22px}.nb-set-description{display:block;font-size:13px;color:var(--nb-muted);margin-top:4px;line-height:20px}.nb-set-header>svg{flex-shrink:0;color:var(--nb-muted);transition:transform .15s}.nb-set-chevron-open{transform:rotate(180deg)}.nb-set-header:hover{background:var(--nb-hover)}
.nb-set-body{padding:0 24px 18px;min-width:0}.nb-set-section{display:flex;flex-direction:column;gap:14px;border-top:1px solid var(--nb-border);padding:18px 0}.nb-set-section>header{display:flex;align-items:center;justify-content:space-between;gap:12px}.nb-set-section h3{font-size:13px;line-height:20px;font-weight:600;margin:0}.nb-set-card .nb-icon{display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;color:var(--nb-muted)}
.nb-set-field{display:flex;flex-direction:column;gap:6px;min-width:0;font-size:13px}.nb-set-select,.nb-set-textarea{width:100%;min-width:0;font-size:13px!important;padding:8px 10px;border:1px solid var(--nb-border);border-radius:6px;background:var(--nb-surface);line-height:20px;color:var(--nb-text)}.nb-set-select{height:38px;text-overflow:ellipsis}.nb-set-textarea{resize:vertical;min-height:90px;overflow-wrap:anywhere}.nb-set-hint{font-size:12px;line-height:19px;color:var(--nb-muted);margin:0;overflow-wrap:anywhere}
.nb-set-toggle{display:flex;align-items:center;justify-content:space-between;gap:16px;min-height:32px;font-size:13px;cursor:pointer}.nb-set-toggle input{appearance:none;position:relative;flex:0 0 34px;width:34px;height:20px;border:0;border-radius:10px;background:var(--nb-border);cursor:pointer;margin:0}.nb-set-toggle input:before{content:'';position:absolute;left:3px;top:3px;width:14px;height:14px;border-radius:50%;background:var(--nb-surface);box-shadow:0 1px 3px #0002}.nb-set-toggle input:checked{background:var(--nb-accent)}.nb-set-toggle input:checked:before{transform:translateX(14px);background:#fff}
.nb-set-colors{display:flex;gap:10px;flex-wrap:wrap;min-height:30px}.nb-set-colors .nb-swatch{display:flex;align-items:center;justify-content:center;width:28px;height:28px;flex:0 0 28px}.nb-set-colors .nb-swatch[aria-pressed=true]{outline:2px solid var(--nb-accent);outline-offset:2px}
.nb-set-model-status,.nb-set-footer{display:flex;align-items:center;justify-content:space-between;gap:10px;min-height:32px}.nb-set-footer{border-top:1px solid var(--nb-border);padding-top:14px}.nb-set-error{font-size:12px;line-height:19px;color:var(--dsw-alias-state-error-primary,#bc3c4b);margin:0;overflow-wrap:anywhere}
.nb-set-advanced{font-size:13px}.nb-set-advanced summary{cursor:pointer;padding:6px 0}.nb-set-advanced .nb-set-field{padding-top:8px}.nb-set-command{display:inline-flex;align-items:center;justify-content:center;gap:7px;align-self:flex-start;max-width:100%;min-height:34px;padding:6px 10px;border:1px solid var(--nb-border);border-radius:6px;background:var(--nb-surface);font-size:13px!important}.nb-set-command:hover{background:var(--nb-hover)}.nb-set-test{display:flex;flex-direction:column;gap:10px;font-size:13px}.nb-set-result{padding-top:12px;border-top:1px solid var(--nb-border);overflow-wrap:anywhere;min-width:0}.nb-set-result pre{overflow:auto;max-width:100%}.nb-set-result img{max-width:100%}
.nb-set-card{border-color:var(--dsw-alias-border-l2,var(--nb-border))}.nb-set-header{padding:14px 16px}.nb-set-header strong{font-size:15px;line-height:21px}.nb-set-description{color:var(--dsw-alias-label-tertiary,var(--nb-muted))}.nb-set-body{padding-left:16px;padding-right:16px}
.nb-set-select-wrap{position:relative;min-width:0}.nb-set-select{appearance:none;-webkit-appearance:none;padding-right:38px}.nb-set-select-arrow{position:absolute;right:12px;top:50%;transform:translateY(-50%);display:flex;align-items:center;justify-content:center;width:14px;height:14px;color:var(--nb-muted);pointer-events:none}.nb-set-select:disabled+.nb-set-select-arrow{opacity:.45}
